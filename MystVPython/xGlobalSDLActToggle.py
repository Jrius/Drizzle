...
intTog1 = ptAttribInt((SubIDStart + 1), 'Toggle Val 1', default=0, rang=(0, 100))
intTog2 = ptAttribInt((SubIDStart + 2), 'Toggle Val 2', default=1, rang=(0, 100))

class xGlobalSDLActToggle(ptModifier):
    ...
    def __init__(self):
        ...
        self.id = 6100
        self.version = 1
        print ('xGlobalSDLActToggle.__init__: version - %d' % self.version)
    ...
    def OnNotify(self, state, id, events):
        ...
        if CheckNotify(state, id, events):
            ...
            newval = intTog1.value
            if (sdlval == intTog1.value):
                newval = intTog2.value
            ageSDL[sdlVar.value] = (newval,)
            print ('xGlobalSDLActToggle.OnNotify: set sdl var %s to %d' % (sdlVar.value, newval))
        else:
