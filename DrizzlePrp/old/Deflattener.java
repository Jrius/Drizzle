...
//        {
//            Tree subtree = new Tree(containertype);
...
//    }
//
//    public Deflattener(Disassemble disassembledCode, PythonXX p)
//    {
//
...
//        //root = Tree.CreateWithType(op.code);
//        root = new Tree(op.code); //no parent
//        for(OpInfo oi: rv)
//        {
//            root.add(new Tree(oi));
//        }
//
//        //start();
...
//        if(o1.is(op.expr) && o0.is(op.designator)) return t.newpop(op.assign, op.expr, op.designator);//return t.pop(2, op.assign);
//        if(o1.is(op.expr) && o0.is(op.RETURN_VALUE)) return t.newpop(op.return_stmt,op.expr,op.RETURN_VALUE);//t.pop(2, op.return_stmt);
//        if(o1.is(op.expr) && o0.is(op.POP_TOP)) return t.newpop(op.call_stmt,op.expr,op.POP_TOP);//t.pop(2, op.call_stmt);
//        if(o2==op.LOAD_CONST && o1==op.IMPORT_NAME && o0==op.IMPORT_STAR) return t.newpop(op.importstar2,op.LOAD_CONST,op.IMPORT_NAME,op.IMPORT_STAR);//t.pop(3, op.importstar2);
...
//            return t.newpop(op.build_tuple, size, op.expr, 1, op.BUILD_TUPLE);
//        }
...
//            return t.newpop(op.mkfunc, size, op.expr, 1, op.LOAD_CONST, 1, op.MAKE_FUNCTION);
//        }
